...
import { conversationDelete, conversationGet, conversationPost, conversationPut } from './chat-assistant';

// GET reads, POST appends to, PUT replaces the complete (edited) history of,
// and DELETE permanently removes one conversation.
export default {
